...
CREATE TABLE IF NOT EXISTS `mydb`.`Coordinates` (
  `idCoordinates` VARCHAR(45) NOT NULL,
  `x` DOUBLE NULL,
  `y` DOUBLE NULL,
  `z` INT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Location` (
  ...
  `roomNumber` INT NULL,
  `Coordinates_idCoordinates` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Favorites` (
  ...
  PRIMARY KEY (`idFavorites`, `User_idUser`, `Location_idLocation`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Classes` (
  ...
  `Location_idLocation` INT NOT NULL,
  `User_idUser` INT NOT NULL,
  PRIMARY KEY (`classTime`, `Location_idLocation`, `User_idUser`),
